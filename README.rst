...
.. code-block:: bash
    ...
    heroku run python projetosae/manage.py syncdb --noinput --settings=config.settings
    heroku run python projetosae/manage.py migrate --settings=config.settings
    heroku run python projetosae/manage.py collectstatic --settings=config.settings
